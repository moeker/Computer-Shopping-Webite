  ...
  <body>
   ...
   <nav class="top-bar" data-topbar role="navigation">
    ...
    <div class="row" style="margin-top:10px;">
      <div class="small-12">
        <?php
         $search_value = $_POST["term"];
          $i=0;
          $product_id = array();
          $product_quantity = array();

          $result = $mysqli->query("SELECT * FROM products WHERE product_name LIKE '%$search_value%' ");
          if($result === FALSE){
            die(mysqli_error());
          }
          ...
          if($result){
            ...
            while($obj = $result->fetch_object()) {
             ...
             // echo '<div class="small-4 columns">';
              ...
              echo '<img src="images/products/'.$obj->product_img_name. '" height="260" width="260" />';
              echo '<br>';
              echo '<br>';
              echo '<br>';
